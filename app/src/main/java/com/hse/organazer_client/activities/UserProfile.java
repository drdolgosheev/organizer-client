...
public class UserProfile extends AppCompatActivity {
    ...
    public static String fUsername = null;
        ...
        switch (requestCode) {
            case GALLERY_REQUEST:
                if (resultCode == RESULT_OK) {
                    ...
                    riversRef = storageRef.child("users/" + fUsername + ".jpeg");
                    ...
                    uploadTask.addOnFailureListener(exception -> {
                        Toast.makeText(UserProfile.this, "Can not Upload an image",
                                Toast.LENGTH_SHORT).show();
                        Log.e("FAILURE:", "Can not Upload an image");
                    }).addOnSuccessListener(taskSnapshot -> {
                        Log.e("Success:", "You Upload an image");
                        Toast.makeText(UserProfile.this, "Photo uploaded",
                                Toast.LENGTH_SHORT).show();
                    });
                }
                try {
